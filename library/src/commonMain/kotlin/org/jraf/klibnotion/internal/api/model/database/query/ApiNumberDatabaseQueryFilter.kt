...
internal data class ApiNumberDatabaseQueryFilter(
    ...
    val does_not_equal: Double? = null,
    val greater_than: Double? = null,
    val less_than: Double? = null,
    val greater_than_or_equal_to: Double? = null,
    val less_than_or_equal_to: Double? = null,
