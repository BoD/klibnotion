...
internal object ApiPageUpdateParametersConverter :
    ApiConverter<ApiPageUpdateParameters, PageUpdateParameters>() {
    override fun modelToApi(model: PageUpdateParameters): ApiPageUpdateParameters {
        return ApiPageUpdateParameters(
