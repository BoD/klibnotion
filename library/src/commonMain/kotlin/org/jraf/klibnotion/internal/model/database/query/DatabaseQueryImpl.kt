...
package org.jraf.klibnotion.internal.model.database.query

import org.jraf.klibnotion.model.database.query.DatabaseQuery
import org.jraf.klibnotion.model.database.query.filter.DatabaseQueryPropertyFilter

internal class DatabaseQueryImpl : DatabaseQuery {
    ...
    override fun addAllFilters(vararg filter: DatabaseQueryPropertyFilter): DatabaseQuery {
        allFilters += filter
        return this
    }

    override fun addAnyFilters(vararg filter: DatabaseQueryPropertyFilter): DatabaseQuery {
        anyFilters += filter
        return this
    }
